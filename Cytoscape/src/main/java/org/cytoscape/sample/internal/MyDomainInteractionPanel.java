...
public class MyDomainInteractionPanel extends JPanel implements CytoPanelComponent {
	
	private static final long serialVersionUID = 8292806967891823933L;
	private MyProject myProject;
	
	public MyDomainInteractionPanel() {
		
		//eines der beiden Panel unten; hier werden Interaktionen zwischen Domains angelegt
		...
		gbl_panel.columnWidths = new int[]{120, 0, 0, 120, 0, 0};
		...
		gbc_chckbxdd1.insets = new Insets(0, 0, 5, 5);
		...
		gbc_checkbxdd2.insets = new Insets(0, 0, 5, 5);
